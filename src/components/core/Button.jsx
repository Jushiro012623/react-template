...
const variants = {
  ...
  light: 'bg-white border text-slate-900 hover:bg-gray-50',
...
export default function Button({ children, variant = 'primary', size = 'small' }) {
  ...
  return (
    <button
      ref={buttonRef}
      className={clsx(
        'relative overflow-hidden border rounded focus:outline-none btn',
        variants[variant],
        sizes[size],
      )}
      onClick={handleClick}
